...
- [ ] 1.6 Test script on systems with Docker only
- [ ] 1.7 Test script on systems with both runtimes (should prefer Podman)
...
- [ ] 4.2 Verify database starts correctly with Docker
- [ ] 4.3 Verify clean script works with both runtimes
- [ ] 4.4 Test error messages when neither runtime is available
